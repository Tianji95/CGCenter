...
namespace Zxen {
    ...
    void Program::SetMVP(const glm::mat4& model, const glm::mat4& view, const glm::mat4& projection) const
    {
    ...
    void Program::checkCompileErrors(unsigned int shader, std::string type)
    {
        int success;
        char infoLog[1024];
        if (type != "PROGRAM") {
